                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" method="post" action="{{ route('team-update', $data->id) }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6 mb-3">
                                        ...
                                        <input type="text" name="designation" class="form-control" id="inputEmail4"
                                            placeholder="Add Role" value="{{ $data->designation }}">
                                        @error('designation')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                        ...
                                        @foreach ($socialmedia as $media)
                                            <div class="form-group col-md-6 mb-3">
                                                ...
                                                <input type="text" name="icon[]" class="form-control" id="inputEmail4"
                                                    placeholder="Add Social Media Icons" value="{{ $media->icon }}">
                                            ...
                                            <div class="form-group col-md-6 mb-3">
                                                ...
                                                <input type="text" name="url[]" class="form-control" id="inputEmail4"
                                                    placeholder="Add Social Media Url" value="{{ $media->url }}">
                                ...
                                <button type="submit" class="btn btn-primary waves-effect waves-light">Update Team</button>
