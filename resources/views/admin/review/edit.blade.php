                            ...
                            <form id="myForm" method="post" action="{{ route('review-update') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-15 mb-3">
                                        <label for="inputEmail4" class="form-label">Company Rating </label>
                                        <input type="number" name="rating" class="form-control" id="inputEmail4"
                                            placeholder="Add Company Rating between 1 to 5" value="{{ $data->rating }}">
                                        @error('rating')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
